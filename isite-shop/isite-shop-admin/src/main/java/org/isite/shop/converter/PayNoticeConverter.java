...
public class PayNoticeConverter {
    ...
    public static PayNoticeDto toAlipayNoticeDto(Map<String, String> params) throws ParseException {
        ...
        payNoticeDto.setOrderNo(parseLong(params.get(AlipayConstants.FIELD_OUT_TRADE_NO)));
        ...
        payNoticeDto.setPaymentNo(parseLong(params.get(FIELD_TRADE_NO)));
    ...
    public static PayNoticeDto toWxpayNoticeDto(Map<String, String> params) throws ParseException {
        ...
        payNoticeDto.setOrderNo(parseLong(params.get(WxpayConstants.FIELD_OUT_TRADE_NO)));
        ...
        payNoticeDto.setPaymentNo(parseLong(params.get(FIELD_TRANSACTION_ID)));
